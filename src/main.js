...
const load = loader({
  ...
  handlers: {
    requires: ['cfg', 'github', 'monitor', 'intree', 'schemaset', 'reference', 'Builds', 'pulseClient', 'CheckRuns'],
    setup: async ({cfg, github, monitor, intree, schemaset, reference, Builds, pulseClient, CheckRuns}) =>
      new Handlers({
        rootUrl: cfg.taskcluster.rootUrl,
